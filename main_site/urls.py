...
from .views import IndexView, BotView, LoginView, login_handler_view, logout_view, discord_login_view, AboutView, TemplateView, BotListView, AddBotView, BotEditView, discord_login_normal
